...
class taskService(ServiceBase):
    ...
    def receive_task_info(ctx, task_info):
        # 检查数据有效性
        required_fields = ['ORDER_NO', 'BATCH_NO', 'PRODUCT_CODE', 'PRODUCT_NAME', 'PRODUCTION_LINE', 'TASK_IDENTIFIER', 'TASK_KEY', 'MATERIAL_TYPE', 'IDENTIFY_TYPE', 'IDENTIFY_NUMBER', 'PRODUCTION_DATE', 'EXPIRY_DATE', 'EQUIPMENT_NO']
