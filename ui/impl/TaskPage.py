...
class TaskPage(QtWidgets.QWidget,Ui_TaskPage):
    ...
    def __init__(self):
        ...
        tasks = [
            { "批号": "CY32404", "物料类型": "小盒","产品名称": "铝管","任务标识符": "包盒IPC 抽查[1.2]","生产线": "支装一线","检测数量": 5 ,"单/双面检测": "双面","是否完成": "未完成"},
            {"批号": "CY32405", "物料类型": "小盒","产品名称": "复方","任务标识符": "包盒IPC 抽查[1.3]","生产线": "支装一线","检测数量": 10, "单/双面检测": "单面","是否完成": "未完成"},
