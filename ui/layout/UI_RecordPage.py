...
class Ui_RecordPage(object):
    ...
    def retranslateUi(self, RecordPage):
        ...
        self.label_3.setText(_translate("RecordPage", "生产批号："))
        self.label_5.setText(_translate("RecordPage", "产品筛选："))
        self.pushButton_1.setText(_translate("RecordPage", "查询"))
        self.pushButton_2.setText(_translate("RecordPage", "升序"))
        self.pushButton_5.setText(_translate("RecordPage", "降序"))
